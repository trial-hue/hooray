          ...
          <details className="mt-4">
            ...
            <table className="mt-3 w-full text-sm">
              <tbody className="divide-y divide-line">
                ...
                <Row k="Phase 2, employees as consumers" a={`Designed, not tested: free for ${CONSUMER.freeCardsPerYear} cards a year, Circle at ${gbp(CONSUMER.subscriptionYearlyGbp)} a year for ${CONSUMER.subscriptionCardsPerYear} sent automatically, ${gbp(CONSUMER.perCardGbp)} a card beyond. Consumer door open at /me/start; no payment taken.`} b={`${gbp(MOONPIG_DERIVED.consumerAllIn)} a card including post`} />
